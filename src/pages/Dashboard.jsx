                ...
                <div className="flex items-center p-6 gap-x-4 w-1/4 bg-white text-neutral-600 rounded-md border">
                    <div className="flex w-10 h-10 bg-green-200 rounded-md">
                        <div className="flex flex-row px-2 text-green-500 text-2xl items-center">    
                            ...
                            <path d="M4.78125 13.4498C4.37125 13.4498 4.03125 13.1098 4.03125 12.6998V8.2998C4.03125 7.8898 4.37125 7.5498 4.78125 7.5498C5.19125 7.5498 5.53125 7.8898 5.53125 8.2998V12.6998C5.53125 13.1098 5.20125 13.4498 4.78125 13.4498Z" fill="currentColor"/>
                            <path d="M16.2109 13.4498C15.8009 13.4498 15.4609 13.1098 15.4609 12.6998V8.2998C15.4609 7.8898 15.8009 7.5498 16.2109 7.5498C16.6209 7.5498 16.9609 7.8898 16.9609 8.2998V12.6998C16.9609 13.1098 16.6309 13.4498 16.2109 13.4498Z" fill="currentColor"/>
                            </svg>
                        </div>
                    </div>
