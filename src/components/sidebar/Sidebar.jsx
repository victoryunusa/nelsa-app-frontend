...
const Sidebar = () => {
    ...
    return (
        ...
        <nav>
            <Link to="/" className="flex space-x-2 items-center font-medium text-sm py-2.5 px-4 my-2 hover:bg-neutral-200 hover:text-neutral-700 transition duration-200 rounded">
            ...
            <Link to="/transactions" className="flex space-x-2 py-2.5 px-4 my-2 items-center font-medium text-sm hover:bg-neutral-200 hover:text-neutral-700 transition duration-200 rounded">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Link to="/settings" className="flex space-x-2 py-2.5 px-4 my-2 font-medium text-sm items-center hover:bg-neutral-200 hover:text-neutral-700 transition duration-200 rounded">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="absolute space-x-2 w-56  bottom-0 h-16">
            <button onClick={logout}  className="flex space-x-2 py-2.5 px-4 my-2 text-sm font-medium items-center hover:bg-neutral-200 hover:text-neutral-700 transition duration-200 rounded-lg">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M14.9991 12.75H3.61914C3.20914 12.75 2.86914 12.41 2.86914 12C2.86914 11.59 3.20914 11.25 3.61914 11.25H14.9991C15.4091 11.25 15.7491 11.59 15.7491 12C15.7491 12.41 15.4091 12.75 14.9991 12.75Z" fill="currentColor"/>
