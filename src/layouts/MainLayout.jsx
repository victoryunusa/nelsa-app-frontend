...
const MainLayout = () => {
  ...
  return (
    <div className="antialiased min-h-screen lg:flex">
      <nav
        className={`absolute ${
          !isOpen ? "-translate-x-full" : "-translate-x-0"
        }  inset-0 transform md:transform-none lg:relative z-10 w-72 bg-teal-900 text-white h-screen p-3`}
      >
      ...
      <div className="relative z-0 lg:flex-grow">
        <header className="flex border-b items-center px-3">
          <button
            onClick={onClick}
          ...
          <span className="block text-2xl sm:text-3xl text-white p-4">
            Header
          </span>
        </header>
