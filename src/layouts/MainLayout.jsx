...
const MainLayout = () => {
  ...
  return (
    <div className="relative min-h-screen font-redhat lg:flex bg-neutral-100 text-gray-800 overflow-x-0">
      <aside
        className={`absolute ${
      ...
      <div className="relative z-0 lg:flex-grow">
        <header className="flex border-b items-center px-3 md:hidden">
          <button
            onClick={onClick}
        ...
        <main className=" w-full p-5 md:p-10 mt-5 text-gray-800 relative z-0 overflow-x-hidden overflow-y-scroll">
          <Outlet />
        </main>
      </div>
    </div>
